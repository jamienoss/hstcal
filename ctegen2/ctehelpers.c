...
{
    newAndZero((void*)&pars->iz_data, pars->nRows, sizeof(*pars->iz_data));
    newAndZero((void*)&pars->wcol_data, pars->nTraps, sizeof(*pars->wcol_data));
    newAndZero((void*)&pars->scale512, pars->nRows, sizeof(*pars->scale512));
    newAndZero((void*)&pars->scale1024, pars->nRows, sizeof(*pars->scale1024));
    newAndZero((void*)&pars->scale1536, pars->nRows, sizeof(*pars->scale1536));
    newAndZero((void*)&pars->scale2048, pars->nRows, sizeof(*pars->scale2048));
